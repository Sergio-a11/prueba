...
public class UsuarioDTO implements Serializable{
    ...
    public UsuarioDTO(int id, String nombre1, String nombre2, String apellido1, String apellido2, String n_identificacion, String correo, String clave, String sexo, Date fecha_nacimineto, int estado) {
        this.id = id;
    ...
    public UsuarioDTO(String nombre1, String nombre2, String apellido1, String apellido2, String n_identificacion, String correo, String clave, String sexo, Date fecha_nacimineto, int estado) {
        this.nombre1 = nombre1;
        this.nombre2 = nombre2;
        this.apellido1 = apellido1;
        this.apellido2 = apellido2;
    ...
    public int hashCode() {
        ...
        hash = 37 * hash + Objects.hashCode(this.fecha_nacimineto);
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.fecha_nacimineto, other.fecha_nacimineto)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "id=" + id + ", nombre1=" + nombre1 + ", apellido1=" + apellido1 + ", correo=" + correo + ", estado=" + estado;
    }
